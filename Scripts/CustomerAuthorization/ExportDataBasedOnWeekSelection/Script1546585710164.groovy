...
CustomKeywords.'CustomerAuthorization.clickEDLPTab'()

CustomKeywords.'CustomerAuthorization.clickExportToExcel'()

CustomKeywords.'CustomerAuthorization.clickHILOTab'()
