...
public class GlobalVariable {
     ...
     * <p></p>
     */
    public static Object menu_customer_setting
     

    static {
        def allVariables = [:]        
        allVariables.put('default', ['url' : 'https://compassreg.myit.kraftheinz.com', 'username' : 'secregst376', 'password' : 'Kraft@2016', 'pageloadwait' : 100, 'waitforelement' : 100, 'menu_accounts_planner' : 'Accounts Planner', 'menu_dashboard' : 'Dashboard', 'multivalueseperator' : ';', 'defaultdateformat' : 'MM/dd/yyyy', 'menu_customer_setting' : ' Customer Settings'])
        ...
        menu_customer_setting = selectedVariables['menu_customer_setting']
